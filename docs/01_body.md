...
В области финансов моделирование применяется для анализа рисков и принятия решений о инвестициях. Модели помогают оценить вероятность возникновения неблагоприятных событий, таких как изменение курсов валют или цен на акции, и принять соответствующие меры (@tbl:t1).

: Неизменяемые параметры проекта по производству «A» {#tbl:t1}
...
Другой областью применения является управление цепями поставок (@fig:body1). Моделирование позволяет анализировать работу всей цепочки поставок, от поставщиков до конечных потребителей, и оптимизировать ее работу. Это может включать в себя планирование запасов, выбор маршрутов доставки, управление складами и многое другое.

![Моделирование при помощи управления цепями поставок](body1.jpg){#fig:body1}

Большинство устойчивых методов базируется на решении задачи (@eq:f1).

$$
\sum_i \varphi\left(y^i - \Theta x^i\right) \to \min
$$ {#eq:f1}
