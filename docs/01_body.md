...
Новые участники альянса открывают возможности для инвестиций в будущее, финансовый сектор, безопасность и развитие новых технологий, транспорт, военную структуру и возможности для обсуждения другого мнения, менталитета другой страны и взгляд со стороны на всемирную ситуацию в целом. Новобранцев объединяют с БРИКС возможности, обсуждения, новые цели, развитие, сотрудничество в проектах для инвестиционного климата будущего и человеческих ресурсов. Например, можно отметить сельскохозяйственный и медицинский секторы, где цифровизация вышла на другой уровень. Это можно отнести больше к положительным факторам, чем к негативным [@F].
...
::: {custom-style="DescriptionPictureText"}
Рисунок 1 – Моделирование при помощи управления цепями поставок
:::
...
::: {custom-style="DescriptionTableText"}
Таблица 1 – Неизменяемые параметры проекта по производству «A»
:::
...
$$
\sum_i \varphi\left(y^i - \Theta x^i\right) \to \min \quad\quad\quad\quad (1)
$$

<br>

::: {custom-style="WidthAdd2Text"}
